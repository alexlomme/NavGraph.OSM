...
#ifndef GOOGLE_PROTOBUF_INCLUDED_osmpbf_2ffileformat_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_osmpbf_2ffileformat_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_osmpbf_2ffileformat_2eproto
...
struct TableStruct_osmpbf_2ffileformat_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_osmpbf_2ffileformat_2eproto;
namespace OSMPBF {
class Blob;
...
class Blob PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_osmpbf_2ffileformat_2eproto);
    return ::descriptor_table_osmpbf_2ffileformat_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_osmpbf_2ffileformat_2eproto;
};
// -------------------------------------------------------------------
...
inline std::string* Blob::unsafe_arena_release_lz4_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:OSMPBF.Blob.lz4_data)
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (_internal_has_lz4_data()) {
    clear_has_data();
...
inline void Blob::unsafe_arena_set_allocated_lz4_data(std::string* lz4_data) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:OSMPBF.Blob.lz4_data)
}
...
inline std::string* Blob::unsafe_arena_release_zstd_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:OSMPBF.Blob.zstd_data)
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (_internal_has_zstd_data()) {
    clear_has_data();
...
inline void Blob::unsafe_arena_set_allocated_zstd_data(std::string* zstd_data) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:OSMPBF.Blob.zstd_data)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_osmpbf_2ffileformat_2eproto
